...
def snake():
    ...
    head = canvas.create_oval(body_x+20, body_y, body_x+40, body_y+20, fill = "red")
...
def move_snake():
    ...
    canvas.coords(snake_part[0],x, y,x + 20, y + 20)   #setzt den kopf auf einen neue position
    prev_x, prev_y = x, y               #Startpunkt der Bewegung
